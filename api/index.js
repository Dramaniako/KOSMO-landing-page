...
async function seedPropertiesAndFacilities(executor = pool) {
  ...
  if (propRows[0].count === 0) {
    await executor.query(`
      ...
      VALUES 
        ('prop-01', 'Cove Nuansa Home Jimbaran', 'Badung', 'Jl. Nuansa Utama Perum Kori Nuansa II No. 9, Jimbaran, Kec. Kuta Selatan, Kabupaten Badung, Bali 80361', 4150000, 4.8, 'https://images.unsplash.com/photo-1522708323590-d24dbb6b0267?auto=format&fit=crop&w=1200&q=80', 'Co-living modern dan tenang di kawasan residential Kori Nuansa Jimbaran. Hanya 8 menit ke Kampus Universitas Udayana (UNUD) Bukit dan Sidewalk Jimbaran. Dilengkapi kamar mezzanine full furnished, smart lock, AC, WiFi dedicated fiber 100 Mbps, dapur bersama, dan rooftop lounge santai.', '-8.7895', '115.1762', 10, 0, 'user-landlord', 'sertifikat_shm_cove_nuansa.pdf'),
        ('prop-02', 'Kawaii Home Jimbaran', 'Badung', 'Jl. Parigata Gang VIII No. 12, Jimbaran, Kec. Kuta Selatan, Kabupaten Badung, Bali 80361', 5300000, 4.7, 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?auto=format&fit=crop&w=1200&q=80', 'Coliving eksklusif dengan sentuhan desain minimalis modern di kawasan strategis Jimbaran. Berjarak hanya 1.5 km dari Universitas Udayana dan 10 menit ke Pantai Jimbaran. Kamar full furnished dengan Queen bed, AC, Smart TV, meja kerja ergonomis, water heater, dan layanan kebersihan kamar rutin.', '-8.7942', '115.1685', 8, 0, 'user-landlord', 'sertifikat_shm_kawaii_home.pdf'),
        ('prop-03', 'Jim''s Coliving Jimbaran', 'Badung', 'Jl. Raya Kampus Unud No. 8, Jimbaran, Kec. Kuta Selatan, Kabupaten Badung, Bali 80361', 3300000, 4.8, 'https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?auto=format&fit=crop&w=1200&q=80', 'Coliving favorit mahasiswa dan remote worker tepat di koridor utama Jl. Raya Kampus Unud Jimbaran. Sangat diminati mahasiswa Udayana, Politeknik Negeri Bali, dan RS Udayana. Unit Studio Queen ber-AC, kamar mandi dalam dengan water heater, WiFi kencang, parkir mobil/motor luas, dan dapur bersama.', '-8.7915', '115.1712', 12, 0, 'user-landlord', 'sertifikat_shm_jims_coliving.pdf'),
        ('prop-04', 'Mari Living Jimbaran', 'Badung', 'Gang Sandat No. 88, Jimbaran, Kec. Kuta Selatan, Kabupaten Badung, Bali 80361', 2900000, 4.8, 'https://images.unsplash.com/photo-1598928506311-c55ded91a20c?auto=format&fit=crop&w=1200&q=80', 'Kost eksklusif modern hanya 5 menit dari Rektorat Universitas Udayana Jimbaran. Kamar full furnished dengan kasur 160x200, Smart TV 43 inch, meja belajar/kerja, kamar mandi dalam water heater, kulkas bersama per lantai, dan rooftop komunal dengan pemandangan patung GWK.', '-8.7980', '115.1690', 8, 0, 'user-landlord', 'sertifikat_shm_mari_living.pdf'),
        ('prop-05', 'Villa Kori Nuansa Jimbaran', 'Badung', 'Jl. Nuansa Kori Utama Selatan No. 4, Taman Griya, Jimbaran, Kec. Kuta Selatan, Kabupaten Badung, Bali 80361', 4800000, 4.7, 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=1200&q=80', 'Hunian bergaya villa coliving asri dan privat di perumahan Taman Griya Jimbaran. Dilengkapi kolam renang outdoor, taman tropis, dapur komunal modern, kamar tidur luas ber-AC dengan kamar mandi pribadi, serta sistem keamanan lingkungan 24 jam.', '-8.7930', '115.1820', 6, 0, 'user-landlord', 'sertifikat_shm_kori_nuansa.pdf'),
        ('prop-06', 'Katsumata Residence Jimbaran', 'Badung', 'Jl. Raya Kampus Unud No. 45, Jimbaran, Kec. Kuta Selatan, Kabupaten Badung, Bali 80361', 3500000, 4.6, 'https://images.unsplash.com/photo-1564013799919-ab600027ffc6?auto=format&fit=crop&w=1200&q=80', 'Kost modern di kawasan strategis Kampus Bukit Jimbaran, hanya 1.6 km dari Sidewalk Mall Jimbaran. Kamar dengan tempat tidur Queen, AC dingin, kamar mandi dalam dengan shower air panas, meja kursi belajar, internet cepat, dan keamanan CCTV 24 jam.', '-8.7960', '115.1740', 10, 0, 'user-landlord', 'sertifikat_shm_katsumata.pdf'),
        ('prop-07', 'DSTAY Kost Bali Jimbaran', 'Badung', 'Jl. Goa Gong No. 19, Jimbaran, Kec. Kuta Selatan, Kabupaten Badung, Bali 80361', 2400000, 4.6, 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&w=1200&q=80', 'Kost tenang dan berhawa sejuk di kawasan perbukitan Jl. Goa Gong Jimbaran, hanya 5 menit ke kawasan wisata GWK dan 7 menit ke Kampus Bukit Unud. Fasilitas kamar ber-AC, kamar mandi dalam, akses WiFi lancar, taman hijau, dapur bersama, dan area parkir motor/mobil aman.', '-8.8050', '115.1660', 10, 0, 'user-landlord', 'sertifikat_shm_dstay_jimbaran.pdf');
    `);
    await executor.query(`
...
async function seedReviews(executor = pool) {
  ...
  if (revRows[0].count === 0) {
    await executor.query(`
      ...
      VALUES 
        ('rev-01', 'prop-01', 'Cove Nuansa Home Jimbaran', 'user-tenant', 'Bayu', 5, 'Tempatnya baru, bersih dan sangat nyaman di kawasan perumahan Taman Griya yang tenang. Desain mezzanine-nya unik dan estetik, AC dingin, serta stafnya ramah dan helpful!', '15 Jul 2026'),
        ('rev-02', 'prop-01', 'Cove Nuansa Home Jimbaran', 'user-tenant', 'Bayu', 5, 'Sangat recommended buat yang butuh ketenangan untuk WFH maupun kuliah di UNUD. Internet dedicated fiber-nya kencang, communal kitchen dan rooftop-nya asik buat santai sore.', '20 Jul 2026'),
        ('rev-03', 'prop-02', 'Kawaii Home Jimbaran', 'user-tenant', 'Bayu', 5, 'Konsep coliving-nya keren dan bersih, kamarnya luas dengan queen bed dan meja kerja yang nyaman. Lokasi dekat banget ke kampus Unud Jimbaran dan tim manajemennya sangat responsif.', '28 Jul 2026'),
        ('rev-04', 'prop-03', 'Jim''s Coliving Jimbaran', 'user-tenant', 'Bayu', 5, 'Lokasinya juara tepat di Jl. Raya Kampus Unud, jalan kaki ke warung makan dan minimarket gampang sekali. Kamar Studio Queen bersih, water heater berfungsi baik, dan parkirannya lega.', '2 Agu 2026'),
        ('rev-05', 'prop-04', 'Mari Living Jimbaran', 'user-tenant', 'Bayu', 5, 'Kost eksklusif yang sangat recommended di Jimbaran! Fasilitas Smart TV 43 inch dan kulkas bersama per lantai sangat membantu. Paling suka rooftop-nya dengan view patung GWK yang megah.', '5 Agu 2026'),
        ('rev-06', 'prop-05', 'Villa Kori Nuansa Jimbaran', 'user-tenant', 'Bayu', 5, 'Suasana villa yang tenang dan asri di Taman Griya Jimbaran. Kolam renang bersih, dapur bersama lengkap, dan lingkungannya aman berpagar. Cocok untuk istirahat yang berkualitas.', '10 Agu 2026'),
        ('rev-07', 'prop-07', 'DSTAY Kost Bali Jimbaran', 'user-tenant', 'Bayu', 4, 'Kost di Jl. Goa Gong yang tenang dan berhawa sejuk di perbukitan Jimbaran. Dekat ke GWK dan pantai-pantai Bukit Selatan. Fasilitas kamar mandi dalam dan AC berfungsi sangat baik.', '14 Agu 2026');
    `);
  }
}
...
function registerSystemRoutes(router2) {
...
function registerAuthRoutes(router2) {
  ...
  router2.get("/users/profile/:id", authenticateToken, async (req, res) => {
    const { id } = req.params;
...
function registerUserRoutes(router2) {
  router2.get("/users", authenticateToken, requireRole(["admin"]), async (_req, res) => {
    try {
  ...
  router2.get("/admin/users", authenticateToken, requireRole(["admin"]), async (_req, res) => {
    try {
      const [rows] = await pool.query(
        "SELECT id, email, name, role, phone, paymentMethod, balance, totalRevenue, totalWithdrawn FROM users ORDER BY id DESC LIMIT 50"
      );
  ...
  router2.delete("/users/:id", authenticateToken, requireRole(["admin"]), async (req, res) => {
    const { id } = req.params;
...
// backend/routes/properties.routes.ts
...
// backend/routes/properties.routes.ts
function registerPropertyRoutes(router2) {
  router2.get("/properties", async (req, res) => {
  ...
  router2.get("/properties/:id", async (req, res) => {
  ...
  router2.put("/properties/:id", authenticateToken, requireRole(["admin", "landlord", "owner"]), async (req, res) => {
    const { id } = req.params;
  ...
  router2.delete("/properties/:id", authenticateToken, requireRole(["admin", "landlord", "owner"]), async (req, res) => {
    const { id } = req.params;
    const { password } = req.body;
    const authUser = req.user;
...
// backend/routes/reviews.routes.ts
function registerReviewRoutes(router2) {
  ...
  router2.put("/reviews/:id", authenticateToken, async (req, res) => {
    const { id } = req.params;
...
function registerLandlordRoutes(router2) {
  ...
  router2.get("/withdrawals", authenticateToken, async (req, res) => {
    const authUser = req.user;
    if (!authUser) {
      return res.status(401).json({ message: "Otentikasi diperlukan." });
    }
  ...
  router2.get("/withdrawals/me", authenticateToken, async (req, res) => {
    const authUser = req.user;
    if (!authUser) {
      return res.status(401).json({ message: "Otentikasi diperlukan." });
    }
  ...
  router2.get("/landlord/rentals", authenticateToken, requireRole(["admin", "landlord", "owner"]), async (req, res) => {
    const authUser = req.user;
    if (!authUser) {
      return res.status(401).json({ message: "Otentikasi diperlukan." });
    }
  ...
  router2.post("/withdraw", authenticateToken, requireRole(["admin", "landlord"]), async (req, res) => {
  ...
  router2.get("/admin/withdrawals", authenticateToken, requireRole(["admin"]), async (req, res) => {
  ...
  router2.post("/admin/withdrawals/:id/process", authenticateToken, requireRole(["admin"]), async (req, res) => {
    const { id } = req.params;
  ...
  router2.post("/admin/withdrawals/:id/reject", authenticateToken, requireRole(["admin"]), async (req, res) => {
    const { id } = req.params;
...
function registerPaymentRoutes(router2) {
  ...
  router2.post("/payment/webhook", handlePaymentNotification);
  router2.post("/payment/notification", handlePaymentNotification);
  router2.post("/payment/finish", authenticateToken, async (req, res) => {
...
function registerRentalRoutes(router2) {
  ...
  router2.get("/tenant/rentals", authenticateToken, async (req, res) => {
    const authUser = req.user;
    if (!authUser) {
      return res.status(401).json({ message: "Otentikasi diperlukan." });
    }
    const tenantId = authUser.role === "admin" && req.query.tenantId ? String(req.query.tenantId) : authUser.id;
    if (!tenantId) {
