        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3.5 items-end">
          ...
          <div className="md:col-span-3 flex gap-2 w-full">
            <button
              ...
              className="btn btn-primary flex-1 h-11 flex items-center justify-center gap-1.5 bg-blue-600 hover:bg-blue-700 disabled:opacity-70 text-white font-semibold px-3 rounded-xl shadow-sm hover:shadow transition text-sm whitespace-nowrap"
            >
              {isSearching ? (
          ...
          {Object.keys(facilities).map((fac) => {
            ...
            return (
              <button
                ...
                className={`px-3 py-1.5 rounded-full text-xs font-medium border transition-all duration-150 cursor-pointer flex items-center gap-1.5 facility-pill min-h-[32px] select-none ${
                  active
