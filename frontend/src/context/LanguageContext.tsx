...
const translations: Record<Language, Translations> = {
  id: {
    ...
    'filter.activeCount': '{count} Filter Aktif',
    'filter.clearAll': 'Hapus Filter',
    'filter.pricePresets': 'Rentang Cepat',
    'filter.presetAll': 'Semua',
    'filter.presetUnder3': '< Rp 3 Jt',
    'filter.preset3to5': 'Rp 3 - 5 Jt',
    'filter.presetAbove5': '> Rp 5 Jt',
    'filter.emptyTitle': 'Tidak Ada Properti Ditemukan',
    'filter.emptyDesc': 'Coba sesuaikan filter wilayah atau turunkan fasilitas pencarian Anda.',
    'filter.resetAllAction': 'Reset Semua Filter',
    'filter.tryAllDistricts': 'Coba: Semua Wilayah',
    ...
    'prop.fullTag': 'Penuh',
    'prop.remaining': 'Sisa {count} Kamar',
    'prop.newTag': 'Baru',
    'prop.verified': 'Sertifikat Terverifikasi',
    'prop.viewDetail': 'Lihat Detail & Sewa',
    'prop.genderCampur': 'Campur • Co-Living',
    'prop.genderTag': 'Campur',
    'prop.dimensions': '3x4 m²',
    'prop.ensuite': 'Kamar Mandi Dalam',
    'prop.roomDimensions': '3x4 m² • Kamar Mandi Dalam',
    'prop.noDeposit': 'Bebas Deposit',
    'prop.detail': 'Detail',
    'prop.selectedRoomBanner': 'Kamar {room} Terpilih',
    ...
    'modal.stepDetail': 'Detail & Kamar',
    'modal.stepContract': 'Kontrak Digital',
    'modal.stepPayment': 'Pembayaran Sewa',
    'modal.stepBack': 'Kembali ke Langkah Sebelumnya',
    'modal.stepProgress': 'Langkah {current} dari {total}',
    'modal.stepProgressSlash': 'Langkah {current} / {total}',
    'modal.totalRent': 'Total Sewa',
    'modal.noUtilityFee': 'Bebas Biaya Utilitas',
  ...
  en: {
    ...
    'filter.pricePresets': 'Quick Price',
    'filter.presetAll': 'All',
    'filter.presetUnder3': '< Rp 3M',
    'filter.preset3to5': 'Rp 3 - 5M',
    'filter.presetAbove5': '> Rp 5M',
    'filter.emptyTitle': 'No Properties Found',
    'filter.emptyDesc': 'Try adjusting your district filter or selecting fewer facility requirements.',
    'filter.resetAllAction': 'Reset All Filters',
    'filter.tryAllDistricts': 'Try: All Districts',
    ...
    'prop.fullTag': 'Fully Booked',
    'prop.remaining': '{count} Rooms Left',
    'prop.newTag': 'New',
    'prop.verified': 'Verified Certificate',
    'prop.viewDetail': 'View Details & Book',
    'prop.genderCampur': 'Mixed • Co-Living',
    'prop.genderTag': 'Mixed',
    'prop.dimensions': '3x4 m²',
    'prop.ensuite': 'Ensuite Bathroom',
    'prop.roomDimensions': '3x4 m² • Ensuite Bathroom',
    'prop.noDeposit': 'Zero Deposit',
    'prop.detail': 'Details',
    'prop.selectedRoomBanner': 'Room {room} Selected',
    ...
    'modal.stepDetail': 'Details & Room',
    'modal.stepContract': 'Digital Contract',
    'modal.stepPayment': 'Lease Payment',
    'modal.stepBack': 'Back to Previous Step',
    'modal.stepProgress': 'Step {current} of {total}',
    'modal.stepProgressSlash': 'Step {current} / {total}',
    'modal.totalRent': 'Total Rent',
    'modal.noUtilityFee': 'Zero Utility Fees',
